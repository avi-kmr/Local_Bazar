...
public class Seller_Profile_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller__profile_);
        ...
        AddProduct.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(Seller_Profile_Activity.this, AddProduct_Activity.class);
        ...
        ViewProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(Seller_Profile_Activity.this, BuyProduct_Activity.class);
                startActivity(intent);
            }
        });
